            ...
            <div  class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 transparence">
                        ...
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="nom_client" placeholder="nom_client">
                        </div>
                        ...
                        <div class="col-md-12">
                            <input type="tele" class="form-control" name="telephone" placeholder="telephone">
                        </div>
                        
                        <label class="label col-md-9 control-label">Solde :</label>
                        <div class="col-md-12">
                            <input type="number" class="form-control" name="solde" placeholder="solde" step="0.01" min="0" value="0">
                        </div>
                        ...
                        <div class="col-md-12">
                            <button class="btn btn-info" type="submit" disabled>Ajouter</button>
