            ...
            <div  class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 transparence">
                        ...
                        <form  method="POST" action="{{route('lignecommande.update',['lignecommande'=> $lignecommande])}}">
                            @csrf 
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="quantite" placeholder="quantite"  value="{{ old('quantite ', $lignecommande->quantite ?? null) }}"  >
                            </div>
