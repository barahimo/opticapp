                                ...
                                <table class="table table-hover" border="0" style="border: 0px solid red">
                                    ...
                                    <tbody style="font-size : 8px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:50%" class="text-left border-right border-left">{{$lignecommande->produit->nom_produit}}</td>
                                            <td style="width:10%" class="text-center border-right border-left">{{$lignecommande->quantite}}</td>
