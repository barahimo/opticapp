  <script type="text/javascript">
            ...
            details = ''; 
              ...
              commande.reglements.forEach((reglement,i) => {
                ...
                var btnDelete2 = `<button 
                    ...
                    onclick="javascript:deleteReglement(${index}${i})">
              ...
              <div class="row">
                <div class="col-8">
                  ...
                  <a 
                    ...
                    href="javascript:deleteCommande(${index})">
                      <i class="fas fa-trash-alt fa-0.5px"></i>
                  </a>
                </div>
    ...
    function deleteCommande(index){
      ...
      Swal.fire({
        title: 'Un client est sur le point de être DÉTRUITE ',
    ...
    function deleteReglement(index){
      ...
      var action = btnDelete.data('route');
      Swal.fire({
        title: 'Un règlement est sur le point de être DÉTRUITE ',
        text: "est ce que vous êtes sur !",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
