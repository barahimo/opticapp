        ...
        <div class="card-body">
            ...
            <!-- ########################################## -->
                ...
                <div class="form-group">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <button id="btnView" class="btn btn-info" onclick="myform(event)">Plus ...</button>
                </div>
            </form>
            <!-- <button id="btnView" class="btn btn-info" onclick="myform()">Plus ...</button> -->
            <!-- <button id="btnView" class="btn btn-info" onclick="btn()">Plus</button> -->
        </div>
    </div>
</div>
@if(session('status'))               
